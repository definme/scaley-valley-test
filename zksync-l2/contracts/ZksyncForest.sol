...
// This contract is zksync specific resource ERC20 contract.
// ZksyncForest — zksync-l2

contract ZksyncForest is ERC20, AccessControl {

    bytes32 MINTER_ROLE = keccak256("MINTER_ROLE");

    uint256 public price;

    constructor(uint256 priceInNative) ERC20("ZksyncForest", "WOOD") {
